    ...
    Fut: Future<Output = Result<(), ()>>,
{
    ...
    let fut_pinned_with_dyn_dispatch: std::pin::Pin<&mut dyn std::future::Future<Output=Result<(), ()>>> = fut_pinned;
    ...
    let poll_outcome = rx.await.expect("Transaction never completed");
